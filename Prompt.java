...
public class Prompt
{
	...
	/**
	 *  Prompts the user and picks up an double.  Checks for
	 *  "bad" input and reprompts if not an double.
	 *  @param ask       The String prompt to be displayed to the user.
	...
	/**
	 *  Prompts the user and picks up an double.  Checks for
	 *  "bad" input and reprompts if not an double.  Also checks
	 *  for input within a given range, and reprompts if outside
	 *  that range.
	 *  @param ask       The String prompt to be displayed to the user.
	 *  @param min       The minimum double value to be allowed as double.
